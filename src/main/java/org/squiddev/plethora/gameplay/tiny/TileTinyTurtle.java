...
public class TileTinyTurtle extends TileBase {
	...
	private static final String TAG_LABEL = "labe;";

	private static final String TAG_UPGRADE_LEFT = "upgrade_left";
	private static final String TAG_UPGRADE_RIGHT = "upgrade_right";
	...
	private EnumFacing getAbsolute(EnumFacing side) {
		return EnumFacing.byHorizontalIndex(side.getHorizontalIndex() - getFacing().getHorizontalIndex());
	}
